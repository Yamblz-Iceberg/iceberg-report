...
После написания тестов мы настроили CI, используя веб-сервис Travis CI. Как в случае с Heroku, пришлось немного помучаться с настройкой конфига для запуска билда.
